...
if command -v netbird &> /dev/null; then
    ...
    echo -e "  \e[1mIf this is a server you should login with your Setup Key:\e[0m"
    echo -e "    \e[33mnetbird up --setup-key <YOUR_SETUP_KEY>\e[0m"
    echo -e "  \e[1mIf this is a client you should login without Setup Key:\e[0m"
