...
The project features an automated, smart backup system using rsync and hard links, as well as an on-demand manual backup utility.

For full details on configuring backups, storage requirements, and running manual backups, see the [Backups Documentation](docs/backups.md).
